...
class LibroPolicy
{
    ...
    {
        return $user->can('delete_any_libro');
    }
    ...
    {
        return $user->can('force_delete_any_libro');
    }
    ...
    {
        return $user->can('restore_any_libro');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Libro $libro): bool
    {
        return $user->can('replicate_libro');
    }
