...
class AutorPolicy
{
    ...
    {
        return $user->can('delete_any_autor');
    }
    ...
    {
        return $user->can('force_delete_any_autor');
    }
    ...
    {
        return $user->can('restore_any_autor');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Autor $autor): bool
    {
        return $user->can('replicate_autor');
    }
